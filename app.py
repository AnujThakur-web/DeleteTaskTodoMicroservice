...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:mydatabase2026.database.windows.net,1433;Database=docker-sql-database;Uid=useradmin;Pwd=Password@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
